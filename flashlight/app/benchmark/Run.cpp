...
void runViTBase(bool fp16 = false) {
  fl::app::benchmark::initStates("ViTBase", fp16);
  ...
  // Print
  fl::app::benchmark::printInfo(benchmarker, batchsize, FLAGS_log_verbose);
}

/* ------------------------------- ResNet34 ------------------------------- */
void runResNet34(bool fp16 = false) {
  fl::app::benchmark::initStates("ResNet34", fp16);
...
void runResNet50(bool fp16 = false) {
  fl::app::benchmark::initStates("ResNet50", fp16);
...
void runDetr(bool fp16 = false) {
  fl::app::benchmark::initStates("Detr", fp16);
...
void runLmTransformer(bool fp16 = false) {
  fl::app::benchmark::initStates("LM Transformer", fp16);
...
void runAsrTransformer(bool fp16 = false) {
  fl::app::benchmark::initStates("ASR Transformer", fp16);
  if (fp16) {
  ...
  fl::app::benchmark::printInfo(
      benchmarker, batchsize * numFrames / 100, FLAGS_log_verbose);
}
